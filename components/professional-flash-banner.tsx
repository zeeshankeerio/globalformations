...
export default function ProfessionalFlashBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] w-full h-16 bg-gradient-to-r from-white via-slate-50 to-blue-50 text-slate-900 relative overflow-hidden shadow-lg border-b border-slate-200">
      {/* Subtle background pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(0,181,137,0.15),transparent_70%)]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(255,255,255,0.08),transparent_70%)]"></div>
